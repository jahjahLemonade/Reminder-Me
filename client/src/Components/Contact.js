  ...
  return (
    <div>
        <div className="px-[1.25rem] mb-48 lg:mb-24 md:px-[4.125rem] lg:px-[1.25rem] xl:px-[9.75rem]">
            <form className="border-4 border-green-800 flex flex-col lg:flex-row  justify-center lg:justify-around bg-[#fff] mt-8 md:mt-20 lg:pt-24 lg:pb-16 rounded-xl" onSubmit={""}>
                <div className="border border-blue-600 flex justify-center py-16"><img className="border border-red-600 w-full sm:max-w-[45rem]" src={contact} /></div>
